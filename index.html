...
Label Denoising Adversarial Network (LDAN) for Inverse Lighting of Face Images
Harmonious Attention Network for Person Re-Identication
...
Dimensionalitys Blessing: Detecting the distributions underlying images
...
A Papier-M塩h?Approach to Learning 3D Surface Generation
A Papier-M塩h?Approach to Learning 3D Surface Generation
...
Language-Based Image Editing with Recurrent attentive Models
SBNet: Sparse Block誷 Network for Fast Inference
SBNet: Sparse Block誷 Network for Fast Inference
...
The Lov噑z-Softmax loss: A tractable surrogate for the optimization of the intersection-over-union measure in neural networks
...
Beyond Gr歜ner Bases: Basis Selection for Minimal Solvers
Beyond Gr歜ner Bases: Basis Selection for Minimal Solvers
...
Seeing Voices and Hearing Faces: Cross-modal biometric matching
OL? Orthogonal Low-rank Embedding, A Plug and Play Geometric Loss for Deep Learning
